...
async function bootstrap() {
    ...
    const projects = await projectRepository.save([
        {
            title: '서울 레지던스',
            description: '서울 강남에 위치한 모던 스타일의 주택입니다. 자연 채광을 최대한 활용한 디자인으로 쾌적한 주거 공간을 제공합니다.',
            location: '서울 강남구',
            client: '김고객',
            year: 2022,
        ...
        {
            title: '부산 오피스',
            description: '부산 해운대에 위치한 오피스 빌딩입니다. 현대적인 디자인과 효율적인 공간 배치로 업무 효율성을 높였습니다.',
            location: '부산 해운대구',
            client: '에이비씨 기업',
            year: 2021,
            status: ProjectStatus.COMPLETED,
        ...
        {
            title: '인천 문화센터',
            description: '인천 송도에 위치한 공공 문화센터입니다. 다양한 문화 활동을 수용할 수 있는 유연한 공간으로 설계되었습니다.',
            location: '인천 송도',
            client: '인천시',
            year: 2023,
            status: ProjectStatus.COMPLETED,
        ...
        {
            title: '제주 카페 인테리어',
            description: '제주의 자연환경을 모티브로 한 카페 인테리어 프로젝트입니다. 지역적 특색을 살린 디자인으로 편안한 휴식 공간을 제공합니다.',
            location: '제주 서귀포시',
            client: '커피하우스',
            year: 2022,
            status: ProjectStatus.COMPLETED,
        ...
        {
            title: '대전 아파트 단지',
            description: '대전에 위치한 친환경적 주거 단지입니다. 공용 시설과 녹지 공간을 적절히 배치하여 주민들의 삶의 질을 향상시켰습니다.',
            location: '대전 유성구',
            client: '건설주식회사',
            year: 2020,
            status: ProjectStatus.COMPLETED,
        ...
        {
            title: '광주 쇼핑몰',
            description: '광주에 위치한 대형 쇼핑몰입니다. 동선 설계와 공간 배치를 최적화하여 쇼핑 경험을 향상시켰습니다.',
            location: '광주 서구',
            client: '리테일 그룹',
            year: 2021,
            status: ProjectStatus.COMPLETED,
